...
const resources = [
  ...
  ['required', 'whisper.dll', join(root, 'resources', 'engines', platform, 'whisper.dll')],
  ['required', 'ggml.dll', join(root, 'resources', 'engines', platform, 'ggml.dll')],
  ['required', 'ggml-base.dll', join(root, 'resources', 'engines', platform, 'ggml-base.dll')],
  ['required', 'ggml-cpu.dll', join(root, 'resources', 'engines', platform, 'ggml-cpu.dll')],
